...
use StorykubeLibrary\Summariser\Tool\Graph;
use StorykubeLibrary\Summariser\Tool\Parser;
use StorykubeLibrary\Summariser\Tool\Score;
use StorykubeLibrary\Summariser\Tool\StopWords\StopWordsAbstract;
use StorykubeLibrary\Summariser\Tool\Summarize;
 ...
 * </code>
 *
 * @package StorykubeLibrary\Summariser\TextRank
 */
class TextRankFacade
{
    /**
     ...
     *
     * @see \StorykubeLibrary\Summariser\Tool\StopWords\English
     *
    ...
    public function setSentencesLimit(int $limit = 3)
    {
        $this->sentencesLimit = $limit;
        return $this;
    }
    ...
    public function summarizeTextCompound(string $rawText): array
    {
        ...
        return $summarize->getSummarize(
            ...
            $text,
            10,
            !empty($this->sentencesLimit) ? $this->sentencesLimit : 3,
            Summarize::GET_ALL_IMPORTANT
        );
    }
